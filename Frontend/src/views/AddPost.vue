<template>
  <div class="add-post-container">
    ...
    <form @submit.prevent="submitPost" class="add-post-form">
      <div class="form-columns">
        <div class="form-column left-column">
          ...
          />
          <label for="post-image" class="upload-button">Choose Image</label>
      ...
      <button type="submit" class="rounded-button">Post</button>
    </form>
  </div>
</template>
